    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModuleRole_Roles_RolesId",
                        column: x => x.RolesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleSubModuleTaggings", x => new { x.ModuleId, x.SubModuleId });
                    table.ForeignKey(
                        name: "FK_ModuleSubModuleTaggings_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ModuleSubModuleTaggings_SubModules_SubModuleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleSubModuleTaggings_SubModuleId",
                table: "ModuleSubModuleTaggings",
                column: "SubModuleId");
